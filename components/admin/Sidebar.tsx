    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            <div style={{ fontSize: '15px', fontWeight: 700, color: '#fff' }}>RBCont</div>
      ...
      {/* Voltar para o RBCont (area publica) */}
      <div style={{ padding: '14px 16px 0' }}>
        <Link
          ...
          style={{
            ...
            backgroundColor: 'rgba(181,121,63,0.12)',
            border: '1px solid rgba(181,121,63,0.35)',
            transition: 'all 0.15s ease',
          }}
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor = 'rgba(181,121,63,0.22)'
            e.currentTarget.style.color = '#fff'
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = 'rgba(181,121,63,0.12)'
            e.currentTarget.style.color = 'rgba(255,255,255,0.85)'
          }}
        >
          <span style={{ fontSize: '14px', lineHeight: 1 }}>←</span>
          Voltar para o RBCont
        </Link>
      </div>
            ...
            <li key={link.href}>
              <Link
                ...
                style={{
                  ...
                  backgroundColor: isActive(link.href) ? 'rgba(181,121,63,0.2)' : 'transparent',
