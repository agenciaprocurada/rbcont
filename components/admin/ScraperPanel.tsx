  ...
  return (
    <div style={{ maxWidth: '900px' }}>
      <p style={{ color: 'var(--text-secondary)', marginBottom: '32px', fontSize: '15px', lineHeight: 1.6 }}>
        Adicione a URL origem (do seu site antigo/WordPress). Iremos investigar e listar todos os tutoriais contidos na página. Em seguida, decida quais deseja copiar, assinale a categoria correspondente e nós recriaremos tudo inteligentemente (limpo, sem menus e sem rodapés) como <strong>Rascunho</strong> no RBCont.
      </p>
            ...
            <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
              {links.map((link, index) => (
                <div key={index} style={{ 
                   ...
                   alignItems: 'center',
                   backgroundColor: link.selected ? 'rgba(181,121,63,0.02)' : 'transparent',
        ...
        <div className="card" style={{ marginTop: '24px', padding: '24px' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '14px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {results.map((res, i) => (
              <li key={i} style={{ 
                padding: '12px 16px', 
                backgroundColor: res.success ? 'rgba(181, 121, 63, 0.05)' : 'rgba(255, 75, 75, 0.05)',
